...
export default async function HomeLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen flex-col space-y-6 bg-home-background bg-cover bg-no-repeat">
      <header className="sticky top-0 z-40 border-b bg-background bg-gray-50 shadow">
        <HomeNav className="container flex items-center justify-between gap-6 px-8 py-2" />
      </header>
